...
import static crawljax.crawltests.SimpleSiteCrawl.NUMBER_OF_EDGES;
import static crawljax.crawltests.SimpleSiteCrawl.NUMBER_OF_STATES;
...
import crawljax.rules.TempDirInTargetFolder;
...
public class SimpleSiteCrawlTest {
	...
	@ClassRule
	public static final TempDirInTargetFolder TMP_FOLDER =
	        new TempDirInTargetFolder("simple-crawl", true);
		...
		SimpleSiteCrawl simpleCrawl = new SimpleSiteCrawl() {
			...
			protected CrawljaxConfigurationBuilder newCrawlConfigurationBuilder() {
				return super.newCrawlConfigurationBuilder()
		                .setOutputDirectory(TMP_FOLDER.getTempDir());
			}
		};
		simpleCrawl.setup();
