...
public class PageObjectAverage extends PageObject {
	...
	/** 
	 * The sensitivity of the hash to (color) change. 
	 * 
	 * The intensity of each color (RGB) is a value from 0-255. The sensitivity
	 * specifies the size of the buckets in which we group intensities, which
	 * means a sensitivity approaching 0 will detect minor changes, while a
	 * sensitivity of 255 will give all images the same hash.
	 */
