...
public abstract class PageObject {
	...
	/**
	 * @param image The image inside the object's bounding box.
	 * @param x The x co-ordinate of the top left of the object's bounding box.
	...
	/**
	 * @param changeType The change operation for this object in the diff.
	 */
	...
	/**
	 * @return {@true} if the images are equal under some function.
	 */
	...
	/**
	 * @return {@code true} if the difference between {@code a} and {@code b} is * 		   within {@code tolerance}.
	 */
	...
	public class ExactMatchComparator {
		...
		public boolean equals(Object o) {
			if(!(o instanceof ExactMatchComparator)) return false;
	...
	public class HashMatchComparator {
		...
		@Override
		public boolean equals(Object o) {
			if(!(o instanceof HashMatchComparator)) return false;
	...
	public class GeographicMatchComparator {
		...
		@Override
		public boolean equals(Object o) {
			if(!(o instanceof GeographicMatchComparator)) return false;
