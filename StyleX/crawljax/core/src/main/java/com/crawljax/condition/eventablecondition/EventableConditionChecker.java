...
public class EventableConditionChecker {
	...
	public boolean checkElementsConditions(EmbeddedBrowser browser, Element element) {
		for (EventableCondition eventableCondition : eventableConditions) {
			if (!eventableCondition.checkAllElementConditionsSatisfied(browser, element)) {
				return false;
			}
		}
		return true;
