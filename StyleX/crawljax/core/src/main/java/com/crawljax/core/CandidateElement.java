...
public class CandidateElement {
	...
	private final ImmutableList<Eventable.EventType> eventTypes;
	...
	public CandidateElement(Element element, Identification identification, String relatedFrame,
	        List<FormInput> formInputs, List<Eventable.EventType> eventTypes) {
	...
	public CandidateElement(Element element, String xpath, List<FormInput> formInputs) {
		this(element, new Identification(Identification.How.xpath, xpath), "", formInputs, ImmutableList.of());
	}

	public CandidateElement(Element sourceElement, Identification identification,
	        String relatedFrame, List<Eventable.EventType> eventTypes) {
		this(sourceElement, identification, relatedFrame, ImmutableList.of(), eventTypes);
	}
	...
	public List<Eventable.EventType> getEventTypes() {
