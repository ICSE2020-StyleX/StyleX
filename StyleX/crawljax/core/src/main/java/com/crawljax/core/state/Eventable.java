...
public class Eventable extends DefaultEdge implements Serializable {
	...
	public enum EventType {
		...
		private static final Map<String, EventType> JS_EVENT_NAME_TO_TYPE = new HashMap<>();

		static {
			for (EventType eventType : EventType.values()) {
				JS_EVENT_NAME_TO_TYPE.put(eventType.getJsEventName(), eventType);
			}
		}

		EventType(String jsEventName) {
			this.jsEventName = jsEventName;
		}

		public static EventType ofJavaScriptEventName(String jsEventName) {
			return JS_EVENT_NAME_TO_TYPE.get(jsEventName);
		}

		public String getJsEventName() {
			return this.jsEventName;
		}
