...
public class DHashStateVertexImpl extends StateVertexImpl {
	 ...
	 */
	@VisibleForTesting
	DHashStateVertexImpl(int id, String name, String dom, String dHashVisual) {
	 ...
	 */
	public DHashStateVertexImpl(int id, String url, String name, String dom, String strippedDom, String dHashVisual) {
	...
	/**
	 * @TODO in the equals, we could also measure the distance between two dHashes
	 */
	@Override
