...
public class CrawlRules {
	...
	public static final class CrawlRulesBuilder {
		...
		public CrawlElement consider(String tagName) {
			return crawlActionsBuilder.consider(tagName);
		}
        ...
        public void setElementSorter(ElementSorter elementSorter) {
			crawlRules.elementSorter = elementSorter;
        }
    }
	...
	public ElementSorter getElementSorter() {
