...
public class StateMachineTest {
	...
	public void testRewind() {
		...
		assertTrue(sm.swithToStateAndCheckIfClone(c3, state4, context));
	...
	public void testInvariants() {
		...
		InMemoryStateFlowGraph sfg = newStateFlowGraph();
		StateMachine smLocal = new StateMachine(sfg, iList, plugins, comparator);
	...
	public void testInvariantFailurePlugin() {
		...
		CrawljaxConfigurationBuilder builder = CrawljaxConfiguration
		        .builderFor("http://localhost").addPlugin(new OnInvariantViolationPlugin() {
			        @Override
